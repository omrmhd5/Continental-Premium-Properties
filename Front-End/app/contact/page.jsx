  ...
  const handleSubmit = (e) => {
    ...
    setTimeout(() => {
      toast({
        ...
        description: isArabic ? "سنتواصل معك في أقرب وقت ممكن" : "We will get back to you as soon as possible",
      })
      setFormData({
        name: "",
        email: "",
        ...
        <section className="py-12">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
            <div>
              ...
              <p className={`text-muted-foreground mt-2 ${isArabic ? "font-arabic" : ""}`}>
                {isArabic
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12">
            {contactInfo.map((info, index) => (
              <Card key={index} className="elegant-card">
                <CardContent className={`flex flex-col items-center p-6 text-center ${isArabic ? "font-arabic" : ""}`}>
                  <div className="mb-4 p-3 bg-primary/10 rounded-full">{info.icon}</div>
                  <h3 className="text-xl font-serif font-bold mb-2">{isArabic ? info.title.ar : info.title.en}</h3>
                  <p className="text-muted-foreground">{isArabic ? info.details.ar : info.details.en}</p>
                </CardContent>
              </Card>
            ))}
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div className={isArabic ? "order-1" : "order-2"}>
              <div className="h-full w-full rounded-lg overflow-hidden elegant-card">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3624.6554812166026!2d46.6752534!3d24.7136!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e2f03890d489399%3A0xba974d1c98e79fd5!2sKing%20Fahd%20Rd%2C%20Riyadh%20Saudi%20Arabia!5e0!3m2!1sen!2sus!4v1650000000000!5m2!1sen!2sus"
                  width="100%"
                  height="100%"
